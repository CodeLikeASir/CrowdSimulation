...
#define  SPAWNED_ACTORS		8192 // should be a squared value for optimal spacing
#define  CELLS_PER_AXIS		128 // Number of cells per axis, this value squared = total cells
...
#define  SPEED				1.4f // Default speed of actors
#define  DRAWN_ACTORS		8192 // Number of actors drawn on screen (others will still be simulated)
#define	 FPS				60.f
